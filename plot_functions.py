...
#         print(list(synapses[section_to_plot]))
            ...
            for loc in list(synapses):
                for weight in list(synapses[loc]):
                    ...
                    text1 = ax.text(time, loc*r, weight,
                                       ha="center", va="center",
                                       color = 'y')   
#         fig.savefig('C:/Users/mkbli/Dropbox/deep_dendrite/Paper/Figures/Figure 2/For supp material/heatmap_nmda_bas_scaledIH.png') 
...
#         plt.plot(cell.t, cell.dend_vs[section_to_plot][-1], label = 'dend 200um', c = 'b') 
    ...
    #     inset_ax.set_ylim([-29, -13])
        ...
        plt.legend()
#         fig.savefig('C:/Users/mkbli/Dropbox/deep_dendrite/Paper/Figures/Figure 2/For supp material/traces_nmda_bas_scaledIH.png') 
            ...
            for loc in list(synapses):
                for weight in list(synapses[loc]):
                    ...
                    text1 = ax.text(time, loc*r, weight,
                                       ha="center", va="center",
                                       color = 'y')   
#         fig.savefig('C:/Users/mkbli/Dropbox/deep_dendrite/Paper/Figures/Figure 2/For supp material/heatmap_nmda_Hay.png') 
        'comment in block for traces'
        fig, ax = plt.subplots(figsize = (5,4), dpi = 300)
        ax.set_title('Voltages' + title )
    #     print(synapses)
...
#         plt.plot(cell.t, cell.dend_vs[section_to_plot][-1], label = 'dend 200um', c = 'b') 
    ...
    #     inset_ax.set_ylim([-29, -13])
        ...
        plt.legend()
#         fig.savefig('C:/Users/mkbli/Dropbox/deep_dendrite/Paper/Figures/Figure 2/For supp material/traces_nmda_Hay.png') 
    return voltage_matrix
...
#     traces = [syn_voltage_traces[0], syn_voltage_traces[1], syn_voltage_traces[2]]
