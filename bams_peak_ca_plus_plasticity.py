...
#     fig.savefig('C:/Users/mkbli/Dropbox/deep_dendrite/Paper/Figures/Figure 6 more new/calcium_plasticity'+str(syn_branches)+'_theta_d_p = '+str(cell.e_synapses[0].theta_d_GB)+'_'+str(cell.e_synapses[0].theta_p_GB)+'.png') 
