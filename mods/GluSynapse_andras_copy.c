...
#define nrn_init _nrn_init__GluSynapse_andras_copy
#define _nrn_initial _nrn_initial__GluSynapse_andras_copy
#define nrn_cur _nrn_cur__GluSynapse_andras_copy
#define _nrn_current _nrn_current__GluSynapse_andras_copy
#define nrn_jacob _nrn_jacob__GluSynapse_andras_copy
#define nrn_state _nrn_state__GluSynapse_andras_copy
#define _net_receive _net_receive__GluSynapse_andras_copy 
#define setRNG setRNG__GluSynapse_andras_copy 
#define state state__GluSynapse_andras_copy 
...
#define mgo_NMDA _p[4]
#define scale_NMDA _p[5]
#define slope_NMDA _p[6]
#define tau_r_NMDA _p[7]
#define tau_d_NMDA _p[8]
#define E_NMDA _p[9]
#define gmax_NMDA _p[10]
#define Use0_TM _p[11]
#define Dep_TM _p[12]
#define Fac_TM _p[13]
#define Nrrp_TM _p[14]
#define Use_d_TM _p[15]
#define Use_p_TM _p[16]
#define spine_head_L _p[17]
#define spine_head_diam _p[18]
#define gca_bar_VDCC _p[19]
#define cao_CR _p[20]
#define tau_exp_GB _p[21]
#define gamma_d_GB _p[22]
#define gamma_p_GB _p[23]
#define gamma_rho_GB _p[24]
#define theta_d_GB _p[25]
#define theta_p_GB _p[26]
#define rho0_GB _p[27]
#define synapseID _p[28]
#define verbose _p[29]
#define selected_for_report _p[30]
#define g_AMPA _p[31]
#define g_NMDA _p[32]
#define ica_NMDA _p[33]
#define i_NMDA _p[34]
#define ica_VDCC _p[35]
#define dep_GB _p[36]
#define pot_GB _p[37]
#define area_mk _p[38]
#define volume_CR_mk _p[39]
#define vsyn _p[40]
#define i _p[41]
#define A_AMPA _p[42]
#define B_AMPA _p[43]
#define gmax_AMPA _p[44]
#define A_NMDA _p[45]
#define B_NMDA _p[46]
#define Use_TM _p[47]
#define m_VDCC _p[48]
...
#define cai_CR _p[50]
#define rho_GB _p[51]
#define effcai_GB _p[52]
#define gca_VDCC _p[53]
#define gca_bar_abs_VDCC _p[54]
#define Eca_syn _p[55]
#define volume_CR _p[56]
#define usingR123 _p[57]
#define DA_AMPA _p[58]
#define DB_AMPA _p[59]
#define Dgmax_AMPA _p[60]
#define DA_NMDA _p[61]
#define DB_NMDA _p[62]
#define DUse_TM _p[63]
#define Dm_VDCC _p[64]
#define Dh_VDCC _p[65]
#define Dcai_CR _p[66]
#define Drho_GB _p[67]
#define Deffcai_GB _p[68]
#define Dgca_VDCC _p[69]
#define Dgca_bar_abs_VDCC _p[70]
#define DEca_syn _p[71]
#define Dvolume_CR _p[72]
#define v _p[73]
#define _g _p[74]
#define _tsav _p[75]
...
#define bbsavestate bbsavestate_GluSynapse_andras_copy
#define brand brand_GluSynapse_andras_copy
#define nernst nernst_GluSynapse_andras_copy
#define urand urand_GluSynapse_andras_copy
...
#define E_AMPA E_AMPA_GluSynapse_andras_copy
 double E_AMPA = 0;
#define gamma_ca_CR gamma_ca_CR_GluSynapse_andras_copy
 double gamma_ca_CR = 0.04;
#define htau_VDCC htau_VDCC_GluSynapse_andras_copy
 double htau_VDCC = 27;
#define kh_VDCC kh_VDCC_GluSynapse_andras_copy
 double kh_VDCC = -9.2;
#define km_VDCC km_VDCC_GluSynapse_andras_copy
 double km_VDCC = 9.5;
#define ljp_VDCC ljp_VDCC_GluSynapse_andras_copy
 double ljp_VDCC = 0;
#define min_ca_CR min_ca_CR_GluSynapse_andras_copy
 double min_ca_CR = 7e-005;
#define mtau_VDCC mtau_VDCC_GluSynapse_andras_copy
 double mtau_VDCC = 1;
#define rho_star_GB rho_star_GB_GluSynapse_andras_copy
 double rho_star_GB = 0.5;
#define tau_effca_GB tau_effca_GB_GluSynapse_andras_copy
 double tau_effca_GB = 200;
#define tau_ind_GB tau_ind_GB_GluSynapse_andras_copy
 double tau_ind_GB = 70;
#define tau_ca_CR tau_ca_CR_GluSynapse_andras_copy
 double tau_ca_CR = 12;
#define tau_r_AMPA tau_r_AMPA_GluSynapse_andras_copy
 double tau_r_AMPA = 0.2;
#define vhh_VDCC vhh_VDCC_GluSynapse_andras_copy
 double vhh_VDCC = -39;
#define vhm_VDCC vhm_VDCC_GluSynapse_andras_copy
 double vhm_VDCC = -5.9;
 ...
 "tau_r_AMPA_GluSynapse_andras_copy", "ms",
 "E_AMPA_GluSynapse_andras_copy", "mV",
 "ljp_VDCC_GluSynapse_andras_copy", "mV",
 "vhm_VDCC_GluSynapse_andras_copy", "mV",
 "km_VDCC_GluSynapse_andras_copy", "mV",
 "vhh_VDCC_GluSynapse_andras_copy", "mV",
 "kh_VDCC_GluSynapse_andras_copy", "mV",
 "mtau_VDCC_GluSynapse_andras_copy", "ms",
 "htau_VDCC_GluSynapse_andras_copy", "ms",
 "gamma_ca_CR_GluSynapse_andras_copy", "1",
 "tau_ca_CR_GluSynapse_andras_copy", "ms",
 "min_ca_CR_GluSynapse_andras_copy", "mM",
 "rho_star_GB_GluSynapse_andras_copy", "1",
 "tau_ind_GB_GluSynapse_andras_copy", "s",
 "tau_effca_GB_GluSynapse_andras_copy", "ms",
 "tau_d_AMPA", "ms",
 "gmax0_AMPA", "nS",
 "gmax_d_AMPA", "nS",
 "gmax_p_AMPA", "nS",
 ...
 static double Eca_syn0 = 0;
 static double Use_TM0 = 0;
 static double cai_CR0 = 0;
 static double delta_t = 0.01;
 static double effcai_GB0 = 0;
 static double gca_bar_abs_VDCC0 = 0;
 static double gca_VDCC0 = 0;
 static double gmax_AMPA0 = 0;
 static double h_VDCC0 = 0;
 static double m_VDCC0 = 0;
 static double rho_GB0 = 0;
 static double volume_CR0 = 0;
 /* connect global user variables to hoc */
 static DoubScal hoc_scdoub[] = {
 "tau_r_AMPA_GluSynapse_andras_copy", &tau_r_AMPA_GluSynapse_andras_copy,
 "E_AMPA_GluSynapse_andras_copy", &E_AMPA_GluSynapse_andras_copy,
 "ljp_VDCC_GluSynapse_andras_copy", &ljp_VDCC_GluSynapse_andras_copy,
 "vhm_VDCC_GluSynapse_andras_copy", &vhm_VDCC_GluSynapse_andras_copy,
 "km_VDCC_GluSynapse_andras_copy", &km_VDCC_GluSynapse_andras_copy,
 "vhh_VDCC_GluSynapse_andras_copy", &vhh_VDCC_GluSynapse_andras_copy,
 "kh_VDCC_GluSynapse_andras_copy", &kh_VDCC_GluSynapse_andras_copy,
 "mtau_VDCC_GluSynapse_andras_copy", &mtau_VDCC_GluSynapse_andras_copy,
 "htau_VDCC_GluSynapse_andras_copy", &htau_VDCC_GluSynapse_andras_copy,
 "gamma_ca_CR_GluSynapse_andras_copy", &gamma_ca_CR_GluSynapse_andras_copy,
 "tau_ca_CR_GluSynapse_andras_copy", &tau_ca_CR_GluSynapse_andras_copy,
 "min_ca_CR_GluSynapse_andras_copy", &min_ca_CR_GluSynapse_andras_copy,
 "rho_star_GB_GluSynapse_andras_copy", &rho_star_GB_GluSynapse_andras_copy,
 "tau_ind_GB_GluSynapse_andras_copy", &tau_ind_GB_GluSynapse_andras_copy,
 "tau_effca_GB_GluSynapse_andras_copy", &tau_effca_GB_GluSynapse_andras_copy,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _GluSynapse_andras_copy_reg() {
	int _vectorized = 1;
  _initlists();
...
#endif
  hoc_register_prop_size(_mechtype, 76, 10);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GluSynapse_andras_copy C:/Users/mkbli/Dropbox/deep_dendrite/mods/GluSynapse_andras_copy.mod\n");
...
/*CVODE*/
 ...
 DA_AMPA = - A_AMPA / tau_r_AMPA ;
   ...
   Dcai_CR = - ( 1e-9 ) * ( ica_NMDA + ica_VDCC ) * gamma_ca_CR / ( ( 1e-15 ) * volume_CR_mk * 2.0 * FARADAY ) - ( cai_CR - min_ca_CR ) / tau_ca_CR ;
   Deffcai_GB = - effcai_GB / tau_effca_GB + ( cai_CR - min_ca_CR ) ;
   Drho_GB = ( - gamma_rho_GB * rho_GB * ( 1.0 - rho_GB ) * ( rho_star_GB - rho_GB ) + pot_GB * gamma_p_GB * ( 1.0 - rho_GB ) - dep_GB * gamma_d_GB * rho_GB ) / ( ( 1e3 ) * tau_ind_GB ) ;
   }
 return _reset;
}
 ...
 Drho_GB = Drho_GB  / (1. - dt*( ( ( (( (( ( - gamma_rho_GB )*( 1.0 ) )*( ( 1.0 - rho_GB ) ) + ( - gamma_rho_GB * rho_GB )*( ( ( - 1.0 ) ) )) )*( ( rho_star_GB - rho_GB ) ) + ( - gamma_rho_GB * rho_GB * ( 1.0 - rho_GB ) )*( ( ( - 1.0 ) ) )) + ( pot_GB * gamma_p_GB )*( ( ( - 1.0 ) ) ) - ( dep_GB * gamma_d_GB )*( 1.0 ) ) ) / ( ( 1e3 ) * tau_ind_GB ) )) ;
  return 0;
}
 /*END CVODE*/
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
  ...
  gca_bar_abs_VDCC = gca_bar_abs_VDCC0;
  gca_VDCC = gca_VDCC0;
  h_VDCC = h_VDCC0;
  m_VDCC = m_VDCC0;
  rho_GB = rho_GB0;
  volume_CR = volume_CR0;
 {
   A_AMPA = 0.0 ;
   B_AMPA = 0.0 ;
   ...
   dep_GB = 0.0 ;
   pot_GB = 0.0 ;
   h_VDCC = 1.0 / ( 1.0 + exp ( ( ( vhh_VDCC - ljp_VDCC ) - v ) / kh_VDCC ) ) ;
   m_VDCC = 1.0 / ( 1.0 + exp ( ( ( vhm_VDCC - ljp_VDCC ) - v ) / km_VDCC ) ) ;
   volume_CR_mk = PI * pow( ( spine_head_diam * 0.5 ) , 2.0 ) * spine_head_L ;
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   double _lEca_syn , _lmggate , _li_AMPA , _lPf_NMDA ;
 g_AMPA = ( 1e-3 ) * gmax_AMPA * ( B_AMPA - A_AMPA ) ;
   ...
   area_mk = spine_head_diam * PI * spine_head_L ;
   gca_bar_abs_VDCC = gca_bar_VDCC * area_mk ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "GluSynapse_andras_copy.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "/**\n"
  " * @file GluSynapse_andras_copy.mod\n"
  " * @author moldwin, kalmenson\n"
  " * @Based on:\n"
  " * @GluSynapse.mod\n"
  ...
  "    RANGE ica_NMDA\n"
  "    : Spine\n"
  "    RANGE volume_CR, area_mk, spine_head_L, spine_head_diam, volume_CR_mk\n"
  "    : VDCC (R-type)\n"
  "    GLOBAL ljp_VDCC, vhm_VDCC, km_VDCC, mtau_VDCC, vhh_VDCC, kh_VDCC, htau_VDCC\n"
  "    RANGE ica_VDCC, gca_bar_VDCC, Eca_syn\n"
  "    RANGE gca_VDCC \n"
  "    RANGE gca_bar_abs_VDCC, cao_CR\n"
  "    : Postsynaptic Ca2+ dynamics\n"
  "    GLOBAL gamma_ca_CR, tau_ca_CR, min_ca_CR\n"
  "    : Long-term synaptic plasticity\n"
  "    GLOBAL rho_star_GB, tau_ind_GB, tau_effca_GB\n"
  "    RANGE gamma_d_GB, gamma_p_GB, gamma_rho_GB, tau_exp_GB\n"
  "    RANGE theta_d_GB, theta_p_GB, rho0_GB, dep_GB, pot_GB, i_NMDA\n"
  "    : Misc\n"
  "    RANGE vsyn, synapseID, selected_for_report, verbose, minf_VDCC, hinf_VDCC\n"
  ...
  "    spine_head_L	= 0.4		(um)		: We added next three lines (mk)\n"
  "    spine_head_diam = 0.4		(um)\n"
  "    :area_mk		    = 		(um2)\n"
  "    : VDCC (R-type) \n"
  "    gca_bar_VDCC    = 0.0744    (nS/um2)    : Density spines: 20 um-2 (Sabatini 2000), unitary conductance VGCC 3.72 pS (Bartol 2015). 15-25pS from Snutch et al. Molecular Properties of Voltage-Gated Calcium Channels\n"
  "    ljp_VDCC        = 0         (mV)\n"
  ...
  "    dep_GB      = 0\n"
  "    pot_GB      = 0\n"
  "    h_VDCC      = 1 / (1 + exp(((vhh_VDCC - ljp_VDCC) - v) / kh_VDCC))\n"
  "    m_VDCC		= 1 / (1 + exp(((vhm_VDCC - ljp_VDCC) - v) / km_VDCC))\n"
  "    \n"
  "    :area_mk	    	= spine_head_L * PI * spine_head_diam :we added these two lines\n"
  "    volume_CR_mk    = PI * (spine_head_diam*0.5)^2 * spine_head_L\n"
  "    :area_mk		= 0.58\n"
  "    \n"
  "    : Initialize watchers\n"
  "    net_send(0, 1)\n"
  ...
  "\n"
  "BREAKPOINT {\n"
  "    LOCAL Eca_syn, mggate, i_AMPA, Pf_NMDA\n"
  "    :LOCAL gca_bar_abs_VDCC\n"
  "    :RANGE gca_VDCC\n"
  ...
  "    :Pf_NMDA = 0.068 :we tried using Schneggenburger 1993\n"
  "    ica_NMDA = Pf_NMDA*g_NMDA*(v-40.0)\n"
  "    :ica_NMDA = Pf_NMDA*i_NMDA : using simple conversion of multiplication by 0.068\n"
  ...
  "    cai_CR'      = - (1e-9)*(ica_NMDA + ica_VDCC)*gamma_ca_CR/((1e-15)*volume_CR_mk*2*FARADAY)\n"
  "    				- (cai_CR - min_ca_CR)/tau_ca_CR\n"
  "    \n"
  "    : Long-term synaptic plasticity\n"
  "    effcai_GB'   = - effcai_GB/tau_effca_GB + (cai_CR - min_ca_CR)\n"
  "    rho_GB'      = ( - gamma_rho_GB*rho_GB*(1 - rho_GB)*(rho_star_GB - rho_GB)\n"
