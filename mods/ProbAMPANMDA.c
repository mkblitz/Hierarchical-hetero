...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 7;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA C:/Users/mkbli/Dropbox/Deep Dendrite/mods/ProbAMPANMDA.mod\n");
...
static const char* nmodl_file_text = 
  ...
  "        mggate = 1 / (1 + exp(0.08 (/mV) * -(v)) * (mg / 3.57 (mM))) :mggate kinetics - Jahr & Stevens 1990, i changed 0.062 to 0.08 in exp()\n"
