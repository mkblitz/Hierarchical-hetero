...
#define nrn_init _nrn_init__GluSynapse_TM_MK
#define _nrn_initial _nrn_initial__GluSynapse_TM_MK
#define nrn_cur _nrn_cur__GluSynapse_TM_MK
#define _nrn_current _nrn_current__GluSynapse_TM_MK
#define nrn_jacob _nrn_jacob__GluSynapse_TM_MK
#define nrn_state _nrn_state__GluSynapse_TM_MK
#define _net_receive _net_receive__GluSynapse_TM_MK 
#define setRNG setRNG__GluSynapse_TM_MK 
#define state state__GluSynapse_TM_MK 
...
#define bbsavestate bbsavestate_GluSynapse_TM_MK
#define brand brand_GluSynapse_TM_MK
#define nernst nernst_GluSynapse_TM_MK
#define urand urand_GluSynapse_TM_MK
...
#define E_AMPA E_AMPA_GluSynapse_TM_MK
 double E_AMPA = 0;
#define gamma_ca_CR gamma_ca_CR_GluSynapse_TM_MK
 double gamma_ca_CR = 0.04;
#define htau_VDCC htau_VDCC_GluSynapse_TM_MK
 double htau_VDCC = 27;
#define kh_VDCC kh_VDCC_GluSynapse_TM_MK
 double kh_VDCC = -9.2;
#define km_VDCC km_VDCC_GluSynapse_TM_MK
 double km_VDCC = 9.5;
#define ljp_VDCC ljp_VDCC_GluSynapse_TM_MK
 double ljp_VDCC = 0;
#define min_ca_CR min_ca_CR_GluSynapse_TM_MK
 double min_ca_CR = 7e-005;
#define mtau_VDCC mtau_VDCC_GluSynapse_TM_MK
 double mtau_VDCC = 1;
#define rho_star_GB rho_star_GB_GluSynapse_TM_MK
 double rho_star_GB = 0.5;
#define tau_effca_GB tau_effca_GB_GluSynapse_TM_MK
 double tau_effca_GB = 200;
#define tau_ind_GB tau_ind_GB_GluSynapse_TM_MK
 double tau_ind_GB = 70;
#define tau_ca_CR tau_ca_CR_GluSynapse_TM_MK
 double tau_ca_CR = 12;
#define tau_r_AMPA tau_r_AMPA_GluSynapse_TM_MK
 double tau_r_AMPA = 0.2;
#define vhh_VDCC vhh_VDCC_GluSynapse_TM_MK
 double vhh_VDCC = -39;
#define vhm_VDCC vhm_VDCC_GluSynapse_TM_MK
 double vhm_VDCC = -5.9;
 ...
 "tau_r_AMPA_GluSynapse_TM_MK", "ms",
 "E_AMPA_GluSynapse_TM_MK", "mV",
 "ljp_VDCC_GluSynapse_TM_MK", "mV",
 "vhm_VDCC_GluSynapse_TM_MK", "mV",
 "km_VDCC_GluSynapse_TM_MK", "mV",
 "vhh_VDCC_GluSynapse_TM_MK", "mV",
 "kh_VDCC_GluSynapse_TM_MK", "mV",
 "mtau_VDCC_GluSynapse_TM_MK", "ms",
 "htau_VDCC_GluSynapse_TM_MK", "ms",
 "gamma_ca_CR_GluSynapse_TM_MK", "1",
 "tau_ca_CR_GluSynapse_TM_MK", "ms",
 "min_ca_CR_GluSynapse_TM_MK", "mM",
 "rho_star_GB_GluSynapse_TM_MK", "1",
 "tau_ind_GB_GluSynapse_TM_MK", "s",
 "tau_effca_GB_GluSynapse_TM_MK", "ms",
 "tau_d_AMPA", "ms",
 "gmax0_AMPA", "nS",
 "gmax_d_AMPA", "nS",
 "gmax_p_AMPA", "nS",
 ...
 "tau_r_AMPA_GluSynapse_TM_MK", &tau_r_AMPA_GluSynapse_TM_MK,
 "E_AMPA_GluSynapse_TM_MK", &E_AMPA_GluSynapse_TM_MK,
 "ljp_VDCC_GluSynapse_TM_MK", &ljp_VDCC_GluSynapse_TM_MK,
 "vhm_VDCC_GluSynapse_TM_MK", &vhm_VDCC_GluSynapse_TM_MK,
 "km_VDCC_GluSynapse_TM_MK", &km_VDCC_GluSynapse_TM_MK,
 "vhh_VDCC_GluSynapse_TM_MK", &vhh_VDCC_GluSynapse_TM_MK,
 "kh_VDCC_GluSynapse_TM_MK", &kh_VDCC_GluSynapse_TM_MK,
 "mtau_VDCC_GluSynapse_TM_MK", &mtau_VDCC_GluSynapse_TM_MK,
 "htau_VDCC_GluSynapse_TM_MK", &htau_VDCC_GluSynapse_TM_MK,
 "gamma_ca_CR_GluSynapse_TM_MK", &gamma_ca_CR_GluSynapse_TM_MK,
 "tau_ca_CR_GluSynapse_TM_MK", &tau_ca_CR_GluSynapse_TM_MK,
 "min_ca_CR_GluSynapse_TM_MK", &min_ca_CR_GluSynapse_TM_MK,
 "rho_star_GB_GluSynapse_TM_MK", &rho_star_GB_GluSynapse_TM_MK,
 "tau_ind_GB_GluSynapse_TM_MK", &tau_ind_GB_GluSynapse_TM_MK,
 "tau_effca_GB_GluSynapse_TM_MK", &tau_effca_GB_GluSynapse_TM_MK,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 GluSynapse_TM_MK C:/Users/mkbli/Dropbox/deep_dendrite/mods/GluSynapse_TM_MK.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "GluSynapse_TM_MK.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "/**\n"
  " * @file GluSynapse_TM_MK.mod\n"
  ...
  "NEURON {\n"
  "    THREADSAFE\n"
  "    POINT_PROCESS GluSynapse_TM_MK\n"
  "    : AMPA Receptor\n"
